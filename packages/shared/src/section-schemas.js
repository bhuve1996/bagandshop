...
exports.getSectionTypesForTemplate = getSectionTypesForTemplate;
exports.getSectionType = getSectionType;
const allowedHomeLanding = ['home', 'landing'];
const allowedAll = ['home', 'product', 'blog_post', 'landing'];
const productOnly = ['product'];
const blogOnly = ['blog_post'];
...
function getSectionTypesForTemplate(templateType) {
    return exports.SECTION_TYPES.filter((s) => s.allowed_templates.includes(templateType));
}
function getSectionType(typeId) {
    return exports.SECTION_TYPES.find((s) => s.type_id === typeId);
}
